% Jeżeli chcemy aby PDF miał tytuł naszej pracy możemy skorzystac z tej konstrukcji
% UWAGA! zmienić dane na właściwe!!!
\usepackage[unicode=true]{hyperref}
\usepackage{float}
\usepackage{caption}
\newcommand\PDFtitle{Szablon Pracy PG - demo - ąśżźćęółń}
\newcommand\PDFauthors{ąśżźćęółń}
\hypersetup{
  pdftitle={\PDFtitle},
...
\usepackage{multicol} % do składu w dwóch kolumnach
